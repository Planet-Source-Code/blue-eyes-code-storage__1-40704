...
Begin {AC0714F6-3D04-11D1-AE7D-00A0C90F26F4} Connect 
   ...
   _ExtentY        =   13626
   _Version        =   393216
   Description     =   "Paste the desired code to a form/module"
   DisplayName     =   "Code Storage By Nazmul Alam"
...
Private Sub AddinInstance_OnConnection(ByVal Application As Object, ByVal ConnectMode As AddInDesignerObjects.ext_ConnectMode, ByVal AddInInst As Object, custom() As Variant)
    ...
    With DB
        ...
        .Properties("DATA SOURCE") = ChkPath(App.Path) + "CodeStorage.mdb"
        .Open
    End With
    ...
    If ConnectMode = ext_cm_External Then
        ...
        Me.Show
    Else
        Set mcbMenuCommandBar = AddToAddInCommandBar("Code Storage")
        'sink the event
